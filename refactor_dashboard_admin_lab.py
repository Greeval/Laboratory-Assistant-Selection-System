...
def refactor_dashboard():
    with open('dashboard_admin_lab.php', 'r', encoding='utf-8') as f:
        content = f.read()
    ...
    content = content.replace('btn-primary', 'btn-sas btn-sas-lab')
    content = content.replace('form-control', 'form-control sas-input focus-lab')
    ...
    with open('dashboard_admin_lab.php', 'w', encoding='utf-8') as f:
        f.write(content)
